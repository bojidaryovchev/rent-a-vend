...
> студени напитки. Машините са нови или изцяло рециклирани, всяка с
> публикувана месечна цена. От ${from} €/месец.

Наемодател на вендинг оборудване в България. За разлика от повечето сайтове в
бранша, тук месечната цена на всеки модел е публикувана предварително, без да
е нужно обаждане.
...
- Всеки модел в каталога е наличен за доставка. Сайтът не публикува бройки по
  модели и не поддържа складова наличност в реално време.
- Част от каталога са нови машини, останалите са изцяло рециклирани. Кое от
  двете важи е отбелязано на страницата на всеки модел. Всяка машина - нова или
  рециклирана - се проверява преди доставка. Годината на производство на
  конкретния апарат се съобщава при запитване.
`;
