...
> студени напитки. Машините са употребявани и изцяло рециклирани, всяка с
...
- Всяка машина се доставя изцяло рециклирана и проверена. Годината на
  производство на конкретния апарат се съобщава при запитване.
`;
