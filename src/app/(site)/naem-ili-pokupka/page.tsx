...
export const metadata: Metadata = pageMetadata({
  ...
  description:
    "Сравнете реалната цена на покупка и наем за 3, 5, 8 или 10 години, със сервиз, ремонти, лихва и остатъчна стойност. Честна сметка, която понякога казва да купите.",
  brandSuffix: false,
});
