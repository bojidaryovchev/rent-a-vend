...
const INTRO: Record<Category, string> = {
  coffee:
    "Машини за кафе и топли напитки под наем. Реални апарати от нашия склад, нови и изцяло рециклирани, с месечна цена на всеки модел.",
  snack:
    "Автомати за снаксове, пакетирани стоки и храна. Нови и изцяло рециклирани, проверени преди доставка.",
  combo:
